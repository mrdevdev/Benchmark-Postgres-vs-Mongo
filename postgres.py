...
def postgres_query_6(dataset, username, password, host, dbname):
...
def postgres_query_1(username, password, host, dbname):
	timer_start = time.time()
...
def postgres_query_2(username, password, host, dbname):
	timer_start = time.time()
	for i in range(0, steps):
		conn = psycopg2.connect(host=host, database=dbname, user=username, password=password)
		cur = conn.cursor()
...
def postgres_query_3(username, password, host, dbname):
	timer_start = time.time()
	for i in range(0, steps):
		conn = psycopg2.connect(host=host, database=dbname, user=username, password=password)
		cur = conn.cursor()
...
def postgres_query_4(username, password, host, dbname):
	for i in range(0, steps):
		conn = psycopg2.connect(host=host, database=dbname, user=username, password=password)
		cur = conn.cursor()
		timer_start = time.time()
...
def postgres_query_5(username, password, host, dbname):
	timer_start = time.time()
	for i in range(0, steps):
		conn = psycopg2.connect(host=host, database=dbname, user=username, password=password)
		cur = conn.cursor()
...
def setup_postgres(username, password, host, dbname):
	conn = psycopg2.connect(host=host, database=dbname, user=username, password=password)
	cur = conn.cursor()
